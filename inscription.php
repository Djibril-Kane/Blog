...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                    <div class="message confirmation">Votre inscription a bien ete prise en compte !</div>
                </div>
            </div>
            <?php
                endif;
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-sm-offset-3">
                    <input type="password" name="password" placeholder="Mot de passe *" value="<?php if(isset($_POST["emailconf"])) echo $_POST["emailconf"] ?>">
                </div>
                <div class="col-sm-6 col-sm-offset-3">
                    <input type="password" name="passwordconf" placeholder="Vérification du mot de passe *" value="<?php if(isset($_POST["passwordconf"])) echo $_POST["passwordconf"] ?>">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
